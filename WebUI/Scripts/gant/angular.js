        ...
        <file name="index.html">
          ...
          <div>
            ...
            <div class="check-element animate-show" ng-show="checked">
              <span class="halfling halfling-thumbs-up"></span> I show up when your checkbox is checked.
            </div>
          </div>
          <div>
            Hide:
            <div class="check-element animate-show" ng-hide="checked">
              <span class="halfling halfling-thumbs-down"></span> I hide when your checkbox is checked.
            </div>
          </div>
        </file>
